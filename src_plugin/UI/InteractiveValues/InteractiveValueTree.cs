...
{
    public class InteractiveValueTree : InteractiveValue
    {
        ...
        public InteractiveValueTree(object value, Type valueType) : base(value, valueType) { }
        ...
        public override void ConstructUI(GameObject parent)
        {
            ...
            GameObject dropdownObj = UIFactory.CreateDropdown(mainContent, "InteractiveValueTree", out dropdown, "", 14, null);
